...
struct riscv_instr_info_t riscv_instr_infos[] = {
    {"UNKNOWN", 0},
    {"LUI",     ARG0_IS_IMMEDIATE | OUT0_IS_RD}, 
    {"AUIPC",   ARG0_IS_IMMEDIATE | ARG1_IS_PC | OUT0_IS_RD}, 
    {"JAL",     ARG0_IS_IMMEDIATE | ARG1_IS_PC | OUT0_IS_RD | OUT1_IS_PC}, 
    {"JALR",    ARG0_IS_IMMEDIATE | ARG1_IS_RS1 | ARG2_IS_PC | OUT0_IS_RD | OUT1_IS_PC},
    {"BEQ",     ARG0_IS_IMMEDIATE | ARG1_IS_RS1 | ARG2_IS_RS2 | OUT0_IS_PC}, 
    {"BNE",     ARG0_IS_IMMEDIATE | ARG1_IS_RS1 | ARG2_IS_RS2 | OUT0_IS_PC}, 
    {"BLT",     ARG0_IS_IMMEDIATE | ARG1_IS_RS1 | ARG2_IS_RS2 | OUT0_IS_PC}, 
    {"BGE",     ARG0_IS_IMMEDIATE | ARG1_IS_RS1 | ARG2_IS_RS2 | OUT0_IS_PC}, 
    {"BLTU",    ARG0_IS_IMMEDIATE | ARG1_IS_RS1 | ARG2_IS_RS2 | OUT0_IS_PC}, 
    {"BGEU",    ARG0_IS_IMMEDIATE | ARG1_IS_RS1 | ARG2_IS_RS2 | OUT0_IS_PC},
    {"LB",      ARG0_IS_RS1 | ARG1_IS_IMMEDIATE | ARG2_COMPUTE_PLUS | OUT0_IS_RD}, 
    {"LH",      ARG0_IS_RS1 | ARG1_IS_IMMEDIATE | ARG2_COMPUTE_PLUS | OUT0_IS_RD}, 
    {"LW",      ARG0_IS_RS1 | ARG1_IS_IMMEDIATE | ARG2_COMPUTE_PLUS | OUT0_IS_RD}, 
    {"LBU",     ARG0_IS_RS1 | ARG1_IS_IMMEDIATE | ARG2_COMPUTE_PLUS | OUT0_IS_RD}, 
    {"LHU",     ARG0_IS_RS1 | ARG1_IS_IMMEDIATE | ARG2_COMPUTE_PLUS | OUT0_IS_RD},
    {"SB",      ARG0_IS_RS1 | ARG1_IS_IMMEDIATE | ARG2_COMPUTE_PLUS | ARG3_IS_RS2}, 
    {"SH",      ARG0_IS_RS1 | ARG1_IS_IMMEDIATE | ARG2_COMPUTE_PLUS | ARG3_IS_RS2}, 
    {"SW",      ARG0_IS_RS1 | ARG1_IS_IMMEDIATE | ARG2_COMPUTE_PLUS | ARG3_IS_RS2},
    {"ADDI",    ARG0_IS_RS1 | ARG1_IS_IMMEDIATE | OUT0_IS_RD}, 
    {"SLTI",    ARG0_IS_RS1 | ARG1_IS_IMMEDIATE | OUT0_IS_RD}, 
    {"SLTIU",   ARG0_IS_RS1 | ARG1_IS_IMMEDIATE | OUT0_IS_RD}, 
    {"XORI",    ARG0_IS_RS1 | ARG1_IS_IMMEDIATE | OUT0_IS_RD},
    {"ORI",     ARG0_IS_RS1 | ARG1_IS_IMMEDIATE | OUT0_IS_RD}, 
    {"ANDI",    ARG0_IS_RS1 | ARG1_IS_IMMEDIATE | OUT0_IS_RD}, 
    {"SLLI",    ARG0_IS_RS1 | ARG1_IS_IMMEDIATE | OUT0_IS_RD}, 
    {"SRLI",    ARG0_IS_RS1 | ARG1_IS_IMMEDIATE | OUT0_IS_RD},
    {"SRAI",    ARG0_IS_RS1 | ARG1_IS_IMMEDIATE | OUT0_IS_RD},
    {"ADD",     ARG0_IS_RS1 | ARG1_IS_RS2 | OUT0_IS_RD}, 
    {"SUB",     ARG0_IS_RS1 | ARG1_IS_RS2 | OUT0_IS_RD}, 
    {"SLL",     ARG0_IS_RS1 | ARG1_IS_RS2 | OUT0_IS_RD}, 
    {"SLT",     ARG0_IS_RS1 | ARG1_IS_RS2 | OUT0_IS_RD}, 
    {"SLTU",    ARG0_IS_RS1 | ARG1_IS_RS2 | OUT0_IS_RD}, 
    {"XOR",     ARG0_IS_RS1 | ARG1_IS_RS2 | OUT0_IS_RD}, 
    {"SRL",     ARG0_IS_RS1 | ARG1_IS_RS2 | OUT0_IS_RD}, 
    {"SRA",     ARG0_IS_RS1 | ARG1_IS_RS2 | OUT0_IS_RD}, 
    {"OR",      ARG0_IS_RS1 | ARG1_IS_RS2 | OUT0_IS_RD}, 
    {"AND",     ARG0_IS_RS1 | ARG1_IS_RS2 | OUT0_IS_RD}, 
    {"FENCE", 0}, 
    {"ECALL", 0}, 
    {"EBREAK", 0},
    {"LWU", ARG0_IS_RS1 | ARG1_IS_RS2 | ARG2_COMPUTE_PLUS}, 
    {"LD", ARG0_IS_RS1 | ARG1_IS_IMMEDIATE | ARG2_COMPUTE_PLUS | OUT0_IS_PC}, 
    {"SD", ARG0_IS_RS1 | ARG1_IS_IMMEDIATE | ARG2_COMPUTE_PLUS | ARG3_IS_RS2}, 
